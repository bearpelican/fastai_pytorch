...
def add_module_metadata(mod, cells):
    ...
    mcode = (f'# For updating jekyll metadata. You MUST reload notebook immediately after executing this cell for changes to save\n'
             f'# Leave blank to autopopulate from mod.__doc__\n'
             f'from fastai.gen_doc.gen_notebooks import update_module_metadata\n'
...
def add_nb_metadata(nb, nb_path):
    ...
    mcode = (f"# For updating jekyll metadata. You MUST reload notebook immediately after executing this cell for changes to save\n"
             f"from fastai.gen_doc.gen_notebooks import update_nb_metadata\n"
